...
pub fn create_app(pool: PgPool, redis: RedisClient) -> Router {
    ...
    Router::new()
        ...
        .route("/users", get(handlers::users::get_users_with_status))
        ...
        .route(
            ...
            post(handlers::users::add_contact),
        )
        .route(
            "/users/:id/contacts/:contact_id",
            delete(handlers::users::remove_contact),
        )
        ...
        .route(
            "/groups/:id/messages",
            get(handlers::messages::get_group_messages),
        )
