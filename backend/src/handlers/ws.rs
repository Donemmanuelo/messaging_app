...
use super::super::services::web_push::{PushSubscription as WebPushSubscription, PushSubscriptionKeys, VapidConfig, send_web_push};
...
async fn handle_socket(mut socket: WebSocket, state: Arc<AppState>, auth_user: AuthUser) {
